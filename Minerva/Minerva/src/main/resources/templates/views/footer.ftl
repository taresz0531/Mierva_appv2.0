...
<div class="footer-div">
	<div class="text-center col-xs-4" id="footer-div" style="margin-top: 60px;">
		<p class="top-margin-10" style="font-size: 10px;">${Session.footer_contact}</p>
		<p style="font-size: 10px;">${Session.footer_address}</p>
	</div>
	<dir class="col-xs-4 text-center" style="margin-top: 85px;">
	...
	<dir class="col-xs-4 text-center" style="margin-top: 80px; float: left;">
			<img src="image/header/kartyak01.png" width="150px" style="margin-top: 25px;" />
			<img src="image/header/kartyak02.png" width="150px" style="margin-top: 20px;"/>
	</dir>
	<img src="image/header/footer.png" class="footer-img"/>
