...
<div class="footer-div">
	<div class="text-center col-xs-4" id="footer-div">
		<p class="top-margin-10" style="font-size: 14px;">${Session.footer_contact}</p>
		<p>${Session.footer_address}</p>
	</div>
	<dir class="col-xs-4 text-center" style="margin-top: 20px;">
	...
	<dir class="col-xs-4 text-center">
		<img src="icon/kartyak.png" height="60"/>
	</dir>
</div>
