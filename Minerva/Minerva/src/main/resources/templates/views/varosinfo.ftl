...
<div class="main-div container">
	<div class="guest-div">
		<center><h1>${Session.vinfo_cim}</h1></center>	
	</div>
	<div class="guest-div" style="margin-top: 25px;">
		<div class="row" style="min-height: 145px;">
			<div class="col-xs-9">
				<h2>${Session.vinfo_nagyt}</h2>
				<p>${Session.vinfo_nagytleir}</p>
	...
	<div class="guest-div"  style="margin-top: 25px;">
		<div class="row" style="min-height: 145px;">
			...
			<div class="col-xs-9">
				...
				<p>${Session.vinfo_egyetemleir}</p>
				<p style="font-size: 10px;">${Session.vinfo_info}<a href="${Session.vinfo_egyetemlink}" target="_blank"><i><b>${Session.vinfo_ide}</b></i></a></p>
			</div>
		</div>
	</div>
	<div class="guest-div"  style="margin-top: 25px;">
		<div class="row" style="min-height: 145px;">
			<div class="col-xs-9">
				<h2>${Session.vinfo_deri}</h2>
				<p>${Session.vinfo_derileir}</p>
	...
	<div class="guest-div"  style="margin-top: 25px;">
		<div class="row" style="min-height: 145px;">
			...
			<div class="col-xs-9">
				...
				<p>${Session.vinfo_reformleir}</p>
				<p style="font-size: 10px;">${Session.vinfo_info}<a href="${Session.vinfo_reformlink}" target="_blank"><i><b>${Session.vinfo_ide}</b></i></a></p>
			</div>
		</div>
	</div>
	<div class="guest-div"  style="margin-top: 25px;">
		<div class="row" style="min-height: 145px;">
			<div class="col-xs-9">
				<h2>${Session.vinfo_piac}</h2>
				<p>${Session.vinfo_piacleir}</p>
	...
	<div class="guest-div"  style="margin-top: 25px;">
		<div class="row" style="min-height: 145px;">
			...
			<div class="col-xs-9">
				...
				<p>${Session.vinfo_szentleir}</p>
				<p style="font-size: 10px;">${Session.vinfo_info}<a href="${Session.vinfo_szentlink}" target="_blank"><i><b>${Session.vinfo_ide}</b></i></a></p>
			</div>
		</div>
	</div>
	<div class="guest-div"  style="margin-top: 25px;">
		<div class="row" style="min-height: 145px;">
			<div class="col-xs-9">
				<h2>${Session.vinfo_zsin}</h2>
				<p>${Session.vinfo_zsinleir}</p>
	...
	<div class="guest-div"  style="margin-top: 25px;">
		<div class="row" style="min-height: 145px;">
			...
			<div class="col-xs-9">
				...
				<p>${Session.vinfo_aqualeir}</p>
				<p style="font-size: 10px;">${Session.vinfo_info}<a href="${Session.vinfo_aqualink}" target="_blank"><i><b>${Session.vinfo_ide}</b></i></a></p>
			</div>
		</div>
	</div>
	<div class="guest-div"  style="margin-top: 25px;">
		<div class="row" style="min-height: 145px;">
			<div class="col-xs-9">
				<h2>${Session.vinfo_kod}</h2>
				<p>${Session.vinfo_kodleir}</p>
	...
	<div class="guest-div"  style="margin-top: 25px;">
		<div class="row" style="min-height: 145px;">
			...
			<div class="col-xs-9">
				...
				<p>${Session.vinfo_vizleir}</p>
				<p style="font-size: 10px;">${Session.vinfo_info}<a href="${Session.vinfo_vizlink}" target="_blank"><i><b>${Session.vinfo_ide}</b></i></a></p>
			</div>
		</div>
	</div>
	<div class="guest-div"  style="margin-top: 25px;">
		<div class="row" style="min-height: 145px;">
			<div class="col-xs-9">
				<h2>${Session.vinfo_agora}</h2>
				<p>${Session.vinfo_agoraleir}</p>
	...
	<div class="guest-div"  style="margin-top: 25px;">
		<div class="row" style="min-height: 145px;">
			...
			<div class="col-xs-9">
				...
				<p>${Session.vinfo_erdoleir}</p>
				<p style="font-size: 10px;">${Session.vinfo_info}<a href="${Session.vinfo_erdolink}" target="_blank"><i><b>${Session.vinfo_ide}</b></i></a></p>
			</div>
		</div>
	</div>
	<div class="guest-div"  style="margin-top: 25px;">
		<div class="row" style="min-height: 145px;">
			<div class="col-xs-9">
				<h2>${Session.vinfo_ady}</h2>
				<p>${Session.vinfo_adyleir}</p>
	...
	<div class="guest-div"  style="margin-top: 25px;">
		<div class="row" style="min-height: 145px;">
			...
			<div class="col-xs-9">
				...
				<p>${Session.vinfo_deriterleir}</p>
				<p style="font-size: 10px;">${Session.vinfo_info}<a href="${Session.vinfo_deriterlink}" target="_blank"><i><b>${Session.vinfo_ide}</b></i></a></p>
			</div>
		</div>
	</div>
	<div class="guest-div"  style="margin-top: 25px;">
		<div class="row" style="min-height: 145px;">
			<div class="col-xs-9">
				<h2>${Session.vinfo_emlek}</h2>
				<p>${Session.vinfo_emlekleir}</p>
	...
	<div class="guest-div"  style="margin-top: 25px;">
		<div class="row" style="min-height: 145px;">
			...
			<div class="col-xs-9">
				...
				<p>${Session.vinfo_halleir}</p>
				<p style="font-size: 10px;">${Session.vinfo_info}<a href="${Session.vinfo_hallink}" target="_blank"><i><b>${Session.vinfo_ide}</b></i></a></p>
			</div>
		</div>
	</div>
	<div class="guest-div"  style="margin-top: 25px;">
		<div class="row" style="min-height: 145px;">
			<div class="col-xs-9">
				<h2>${Session.vinfo_medgy}</h2>
				<p>${Session.vinfo_medgyleir}</p>
	...
	<div class="guest-div"  style="margin-top: 25px;">
		<div class="row" style="min-height: 145px;">
			...
			<div class="col-xs-9">
				...
				<p>${Session.vinfo_csokileir}</p>
				<p style="font-size: 10px;">${Session.vinfo_info}<a href="${Session.vinfo_csokilink}" target="_blank"><i><b>${Session.vinfo_ide}</b></i></a></p>
			</div>
		</div>
	</div>
	<div class="guest-div"  style="margin-top: 25px;">
		<div class="row" style="min-height: 145px;">
			<div class="col-xs-9">
				<h2>${Session.vinfo_botanik}</h2>
				<p>${Session.vinfo_botanikleir}</p>
	...
	<div class="guest-div"  style="margin-top: 25px;">
		<div class="row" style="min-height: 145px;">
			...
			<div class="col-xs-9">
				...
				<p>${Session.vinfo_veresleir}</p>
				<p style="font-size: 10px;">${Session.vinfo_info}<a href="${Session.vinfo_vereslink}" target="_blank"><i><b>${Session.vinfo_ide}</b></i></a></p>
			</div>
		</div>
	</div>
	<div class="guest-div"  style="margin-top: 25px;">
		<div class="row" style="min-height: 145px;">
			<div class="col-xs-9">
				<h2>${Session.vinfo_kultur}</h2>
				<p>${Session.vinfo_kulturleir}</p>
	...
	<div class="guest-div"  style="margin-top: 25px;">
		<div class="row" style="min-height: 145px;">
			...
			<div class="col-xs-9">
				...
				<p>${Session.vinfo_modemleir}</p>
				<p style="font-size: 10px;">${Session.vinfo_info}<a href="${Session.vinfo_modemlink}" target="_blank"><i><b>${Session.vinfo_ide}</b></i></a></p>
			</div>
		</div>
	</div>
	<div class="guest-div"  style="margin-top: 25px;">
		<div class="row" style="min-height: 145px;">
			<div class="col-xs-9">
				<h2>${Session.vinfo_hort}</h2>
				<p>${Session.vinfo_hortleir}</p>
